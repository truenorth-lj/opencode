...
import { applyTnClawSessionEnv, protectSessionlessEnv } from "@/tn-claw/session-env"
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Pty.create")(function* (input: InternalCreateInput) {
      ...
      const env = input.sessionID ? applyTnClawSessionEnv(baseEnv, input.sessionID) : protectSessionlessEnv(baseEnv)
